...
// TestRecentActivityBadge tests a badge that rewards user activity within the last 30 days
// It demonstrates the $timeWindow operator with the 'last' parameter
func TestRecentActivityBadge(t *testing.T) {
	SetupTest()
	...
	testUserID := "test_user_recent" // Consistent user ID for this test
